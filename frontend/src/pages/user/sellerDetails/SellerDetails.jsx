                ...
                <div className='md:max-w-[50rem] sm:max-w-[37rem] w-screen'>
                    ...
                    {isReview && reviewloading && <div className='flex flex-col justify-around sm:pb-4 pb-2 border-green-700 border-2 rounded-3xl'>
                        ...
                        <div className='flex items-start border-2 border-gray-100 rounded-2xl sm:px-4 px-2 py-4 sm:mx-4 mx-2 sm:mt-4 mt-2'>
                            ...
                            <div className='flex-grow'>
                                <div className='sm:text-xl rounded-lg text-base font-bold bg-gray-200 text-gray-200 animate-pulse w-fit'>Sakshi Singh</div>
                                <div className='italic rounded-lg mt-1 sm:text-base text-sm bg-gray-200 text-gray-200 animate-pulse w-fit'>sakshikumari91150@gmail.com</div>
            ...
            {loading && <div className={'py-[4rem] flex justify-center mx-2 sm:mx-0 duration-300'}>
                <div className='md:w-[50rem] sm:w-[37rem]'>
                    <div className='flex sm:mx-4 sm:mt-8 mt-4 items-center bg-gray-100 rounded-full py-4 md:px-0 px-4'>
                        ...
                        <div className='sm:text-base text-[12px] sm:pr-8'>
                            <div className='mb-1 bg-gray-200 text-gray-200 rounded-lg animate-pulse w-fit'><span className='font-semibold'>Brandname : </span>Botania</div>
                            <div className='bg-gray-200 text-gray-200 rounded-lg animate-pulse w-fit'><span className='font-semibold'>Name : </span>Sakshi Singh</div>
                            <div className='bg-gray-200 text-gray-200 rounded-lg animate-pulse w-fit mt-1'><span className='font-semibold'>Email : </span>sakshikumari91150@gmail.com</div>
                        </div>
                    </div>
                    <div className='flex justify-between bg-gray-100 rounded-full items-center sm:px-10 px-8 sm:mx-4 py-4 mt-4'>
                        <div className='flex justify-center items-center flex-col'>

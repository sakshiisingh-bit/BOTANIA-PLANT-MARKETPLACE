      ...
      <div className=''>
        ...
        <div className='bg-black flex flex-col py-4 items-center text-white'>
          <div className='md:max-w-[50rem] mx-4'>
            ...
            <div className='mt-1'><FontAwesomeIcon className='mr-2 w-4 h-4' icon={faEnvelope} />sakshikumari91150@gmail.com</div>
            <div className='mt-1'><FontAwesomeIcon className='mr-2 w-4 h-4' icon={faLocationDot} />India</div>
          </div>
        </div>
      </div>
    </>
